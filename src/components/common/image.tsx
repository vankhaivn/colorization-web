...
ImageWrapper.displayName = AvatarPrimitive.Root.displayName
...
>(({ className, ...props }, ref) => (
    <AvatarPrimitive.Fallback
        ref={ref}
        className={cn("flex h-full w-full items-center justify-center bg-muted rounded-md", className)}
        {...props}
    />
))
ImageFallback.displayName = AvatarPrimitive.Fallback.displayName

export { ImageWrapper, Image, ImageFallback }
